...
function selectRandom(cardsArray) {
  // definir um número randomico baseado no tamanho (length) do array passado - OK
  // retorna o object no indice obtido - OK
  const min = 0;
...
const mysteryObj = pickMystery();

console.log(revealMystery(mysteryObj));
